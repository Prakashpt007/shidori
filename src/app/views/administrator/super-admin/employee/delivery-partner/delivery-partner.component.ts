...
export class DeliveryPartnerComponent {
	...
	constructor() {
		this.form = this.formBuilder.group({
			...
			vehicle_no: ['', [Validators.required, Validators.minLength(10), Validators.maxLength(10)]],
			vehicle_insurance: ['', [Validators.required, validatePdf()]],
			driving_licence: ['', [Validators.required, validatePdf()]],
		});
